...
def dashboard_view(request):
    ...
    for unidad in UnidadAcademica.objects.all():
        # Nota: Laboratorio no tiene relación directa con unidad_academica
        # Se puede filtrar a través de equipos o insumos si es necesario
        laboratorios_count = Laboratorio.objects.count()  # Total general por ahora
